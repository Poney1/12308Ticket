 ...
 * @auther: lixiangxiang
 */
public class DirectStartCityDao extends AbstractDao<BusStartCity,String> {

    public static final String TABLENAME ="DIRECTSTARTCITY";
    ...
    public DirectStartCityDao(DaoConfig config) {
        super(config);
    }

    public DirectStartCityDao(DaoConfig config, AbstractDaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'DIRECTSTARTCITY' (" + //
        ...
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_DIRECTSTARTCITY_NAME_PINYIN ON DIRECTSTARTCITY" +
                " (NAME,PINYIN);");
    }

    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'DIRECTSTARTCITY'";
        db.execSQL(sql);
    }
