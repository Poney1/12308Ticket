 ...
 * @auther: lixiangxiang
 */
public class StationDescriptionEntity  implements Serializable{
     ...
     * childrenTicketInfo : []
     * getTicketWay : 0
     * rentCarPriceList : [{"id":"123","name":"7座商务车","price":3000}]
     */
    ...
    private List<?> childrenTicketInfo;
    /**
     * id : 123
     * name : 7座商务车
     * price : 3000
    ...
    private List<RentCarPriceListBean> rentCarPriceList;
    ...
    public List<?> getChildrenTicketInfo() {
        return childrenTicketInfo;
    }

    public void setChildrenTicketInfo(List<?> childrenTicketInfo) {
        this.childrenTicketInfo = childrenTicketInfo;
    }

    public List<RentCarPriceListBean> getRentCarPriceList() {
        return rentCarPriceList;
    }

    public void setRentCarPriceList(List<RentCarPriceListBean> rentCarPriceList) {
        this.rentCarPriceList = rentCarPriceList;
    }
    ...
    public static class RentCarPriceListBean {
        private String id;
        private String name;
        private int price;
